...
var url = {
    world: "/data_visualizations/Homework5/gist/world-50m.json",
    earthquakes:  "/data_visualizations/Homework5/4.5_month.csv"  
};
...
function symbolMap() {
    ...
    function chart(id) {
        ...
        var scale_angle = d3.scale.linear()
            .domain([-(bbox.width + 1)/2/Math.PI, (bbox.width + 1)/2/Math.PI])
            .range([-180, 180]);
    ...
    function updateLog(message) {
        ...
        log.text(message).style("font-size","22px");
    }
    ...
    function showHighlight(d) {
        ...
        updateLog(d.place + 
            " had an earthquake with a magnitude of " + d.mag +
            ", and depth of " + d.depth + ".");
    }
