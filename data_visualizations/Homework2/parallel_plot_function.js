function parallel_plot_func(svgid,holderid,my_height,my_width) {
	...
	d3.csv("state.x77.csv", function(error, cars) {

	  // Extract the list of dimensions and create a scale for each.
	  x.domain(dimensions = d3.keys(cars[0]).filter(function(d) {
	    return ((d == "HS.Grad") || (d == "Income") || (d == "Life.Exp") || (d == "Murder")  ) && (y[d] = d3.scale.linear()
